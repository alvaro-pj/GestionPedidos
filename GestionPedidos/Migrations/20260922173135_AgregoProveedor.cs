...
{
    /// <inheritdoc />
    public partial class AgregoProveedor : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cif = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ...
                    Poblacion = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
